...
from electricity_descriptive_stats import do_elec_descriptive_stats
...
from linear_regression_helper import (
    elec_linear_regression_all, elec_linear_regression_parts
)
...
def do_electricity_analysis(df_util):
    ...
    elec_linear_regression_all(df_util=df_util, figname=figname)
    ...
    m_list, b_list, scipy_linreg = elec_linear_regression_parts(
    ...
    pred_file = 'output/elec_predictions.tsv'
