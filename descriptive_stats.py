...
def do_elec_descriptive_stats(prefix=None, df_util=None, top_up=None):
    ...
    pf.plot_raw_and_fixed_credits(
        df=df_util, x_lim=x_lim, y_lim=y_lim, xtick_step=20, xlabels=xlabels,
        ylabels=ylabels, titles=titles, figsize=[10, 12], figname=figname
    )
    ...
    pf.make_countplot(
        data=df_util, x='measured', hue=None, stat='count', palette=None, 
        saturation=1, title=title, xlabel='Measurement', ylabel='Count', 
        figsize=[8, 6], add_bar_labels=True, hue_order=None, figname=figname
    )
    ...
    pf.make_countplot(
        data=df_util, x='ac_use', hue=None, stat='count', saturation=1,
        palette=None, title=title, xlabel='AC use', ylabel='Count', 
        hue_order=None, add_bar_labels=True, figsize=[8, 6], figname=figname
    )
    ...
    pf.make_countplot(
        data=df_util, x='ac_use', hue='measured', stat='count', palette=None, 
        saturation=1, xlabel='AC use', ylabel='Count', add_bar_labels=True, 
        hue_order=None, title=title, figsize=[8,6],
        figname=figname
    )      
    ...
    min_et = df_util['time_elapsed'].min()
    min_et=math.floor(min_et)
    max_et = df_util['time_elapsed'].max()
    max_et=math.ceil(max_et)
    ...
    fig_ctr = 6
    ylabel='Credit Used (GHS)'
    title='Weekly Usage (GHS)'
    figname = (
        f'output/{prefix}_{str(fig_ctr).zfill(2)}_weekly_usage.png'
    )
    pf.plot_weekly_usage(
        df=weekly_usage_df, figsize=[20, 10], ylabel=ylabel, title=title, 
        figname=figname
    )
    ...
    pf.make_histogram(
        df=df_util, x='ghs_used', hue=None, stat='percent', palette=None, 
        alpha=1, xlabel='Credit Used (GHS)', ylabel='Freqency (%)', 
        binrange=[0,60], bins=30, title='Histogram of Credit Used', 
        hue_order=None, hue_labels=None, figsize=[8, 6], add_bar_labels=False, 
        figname=figname
    )
    ...
    pf.make_boxplot(
        df=df_util, x=None, y='ghs_used', xtick_vals=None, xtick_labels=None, 
        xlabel=None, ylabel='Credit Used (GHS)', figsize=[4,6],
    ...
    pf.make_histogram(
        ...
        alpha=1, binrange=[0,60], bins=30, xlabel='Credit Used (GHS)', 
        hue_order=[0, 1], hue_labels=None, figsize=[8, 6], 
    ...
    pf.make_boxplot(
        ...
        xlabel='AC Usage', xtick_labels=['Without AC', 'With AC'], 
        ylabel='Credit Used (GHS)', figsize=[8, 6], 
    ...
    pf.make_histogram(
        ...
        alpha=0.5, binrange=[0, 60], bins=30, xlabel='Credit Used (GHS)', 
        figsize=[8, 6], ylabel='Freqency (%)', 
        title='Histogram of Credit Used disaggregated by Part',
        hue_order=[1, 2, 3, 4], hue_labels=None, add_bar_labels=False, 
        figname=figname
    )
...
def do_wifi_descriptive_stats(prefix=None, df_util=None, top_up=None):
    # Make a Graph of credit vs day (raw data and normalized baseline)    
    fig_ctr = 0
    x_lim = [0, 360]
    y_lim = [0, 4000]
    xlabels = ['', 'Day Count']
    ylabels = ['Credit (GB)', 'Credit (GB)']
    titles = [
        'Credit (GB) vs Day for Raw Data', 
        'Credit vs Day (Normalized baseline)'
    ]
    ...
    # Plot Credit Usage by week  
    fig_ctr = 4
    ylabel='Credit Used (GB)'
    title='Weekly Usage (GB)'
    figname = (
        f'output/{prefix}_{str(fig_ctr).zfill(2)}_weekly_usage.png'
    )
    pf.plot_weekly_usage(
        df=weekly_usage_df, ylabel=ylabel, title=title, figsize=[20, 10], 
        figname=figname
    )
    ...
    fig_ctr = 5
    ylabel='Credit Used (GB)'
    title='Monthly Usage (GB)'
    figname=f'output/{prefix}_{str(fig_ctr).zfill(2)}_monthly_usage.png'
    pf.plot_monthly_usage(
        df=monthly_usage_df, ylabel=ylabel, title=title, figsize=[8, 6], 
        figname=figname,
    )
    ...
    pf.make_histogram(
        df=df_util, x='ghs_used', hue=None, stat='percent', palette=None, 
        alpha=1, xlabel='Credit Used (GB)', ylabel='Freqency (%)', 
        binrange=[0,60], bins=30, title='Histogram of Credit Used', 
        hue_order=None, hue_labels=None, figsize=[8, 6], add_bar_labels=False, 
        figname=figname
    )
    ...
    pf.make_boxplot(
        df=df_util, x=None, y='ghs_used', xtick_vals=None, xtick_labels=None, 
        xlabel=None, ylabel='Credit Used (GB)', figsize=[4,6],
        title='Box Plot of Credit Used', figname=figname
    )